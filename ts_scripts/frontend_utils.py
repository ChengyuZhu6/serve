...
def test_frontend():
    ...
    try:
        _ = subprocess.run(frontend_gradlew_cmd, capture_output=True, text=True, check=True)
    except subprocess.CalledProcessError as e:
        print(f"## Frontend Gradle Build and Tests Failed with exit code {e.returncode}!")
